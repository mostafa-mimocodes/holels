        ...
        <portal to="subHeader">
            ...
            >
                <template #action-buttons>
                    <a href="#" class="btn btn-light-danger font-weight-bolder btn-sm mr-1">Page</a>
                    <a href="#" class="btn btn-light-success font-weight-bolder btn-sm mr-1">Profile</a>

                </template>
                <!--begin::Toolbar-->
                <!--begin::Actions-->
                <sub-header-action-item item-title="Today" />
                <sub-header-action-item item-title="Month" />
                <sub-header-action-item item-title="Year" />
                <!--end::Actions-->
                <!--begin::Dropdowns-->
                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                    ...
                    <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right py-3">
                        ...
                        <ul class="navi navi-hover py-5">
                            <sub-header-dropdown-item icon-name="drop" item-title="New Group" />
                            <sub-header-dropdown-item  item-title="Contacts" />
                            <sub-header-dropdown-item icon-name="rocket-1" item-title="Groups" badge-title="new"/>
                            <sub-header-dropdown-item icon-name="bell-2" item-title="Calls" />
                            <sub-header-dropdown-item icon-name="gear" item-title="Settings" />

                            <li class="navi-separator my-3"></li>
                            <sub-header-dropdown-item icon-name="magnifier-tool" item-title="Help" />
                            <sub-header-dropdown-item icon-name="bell-2" item-title="Privacy" badge-style="danger" lable-style="label-rounded" badge-title="5"/>
                    ...
                    <widget2 color="success">
                        <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                            ...
                            <div class="d-flex flex-column text-right">
                                ...
                                <span class="text-muted font-weight-bold mt-2">{{ $t("dashboard.weeklyIncome") }}</span>
                            </div>
                        </div>
                    </widget2>
                    <!--end::Stats Widget 11-->
                    <!--begin::Stats Widget 12-->
                    <widget2 color="primary">
                        <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
...
import SubHeaderActionItem from "@/components/SubHeader/SubHeaderActionItem.vue";
import SubHeaderDropdownItem from "@/components/SubHeader/SubHeaderDropdownItem.vue";
import Widget1 from "@/Dashboard Widgets/Widget1.vue";
import ListWidget from "@/Dashboard Widgets/ListWidget.vue";
import Widget2 from "@/Dashboard Widgets/Widget2.vue";
import {mapGetters} from "vuex";

export default {
    name:"Dashboard",
    components:{Widget2, ListWidget, Widget1, SubHeaderDropdownItem, SubHeaderActionItem, Head,SubHeader},
    layout: DashboardLayout ,
    computed:{
        ...mapGetters({count:'numberToMoney'})
    },
    mounted() {

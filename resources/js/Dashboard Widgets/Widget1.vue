<template>
    ...
    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
        ...
        <div class="card-body p-0 position-relative overflow-hidden">
            <!--begin::Chart-->
            <apexchart class="bg-danger card-rounded-bottom" height="200" type="area" :options="options" :series="series"></apexchart>
            <!--end::Chart-->
            <!--begin::Stats-->
            <div class="card-spacer mt-n25">
                ...
                <div class="row m-0">
                    ...
                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                        ...
                        <a href="#" @click="add" class="text-primary font-weight-bold font-size-h6 mt-2">New Users</a>
                    </div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
    ...
    data(){
        return {
            ...
            options: {
                ...
                markers: {
                    colors: [
                        KTAppSettings['colors']['theme']['light']['danger'],
                    ],
                    strokeColor: ["#D13647"],
                    strokeWidth: 3,
                },
